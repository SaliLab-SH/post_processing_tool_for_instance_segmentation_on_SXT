'''
mAP result for testdataset, insulin vesicle
...
def read_isgfile(idx):
    ...
    # path2 = f'F:/salilab/salilab/projects/organelle-separation/analysis_data/isg_output_fake' 
    path2 = f'F:/salilab/salilab/projects/organelle-separation/analysis_data/isg_output_fake_watershed_smooth'

    # idxlst = [i for i in range(10)]

    filename1 = f'{path1}/vesicle_sample_5isg_{idx}.tiff'
    # filename2 = f'{path2}/{idx}_instance_mask.tiff'
    filename2 = f'{path2}/{idx}_watershed_mask_smooth.tiff'
